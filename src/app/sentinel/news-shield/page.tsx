...
const data: ProductPageData = {
  ...
  performanceSubtitle: 'Accounts with news protection lose 60% less during scheduled news events.',
  performanceData: [
    {
      symbol: 'XAUUSD',
      metrics: [
        { label: 'Loss Reduction', value: '68%' },
        { label: 'Events Shielded', value: '312' },
        { label: 'Avg Spike', value: '280 pips' },
      ],
      trades: '847',
    },
    {
      symbol: 'EURUSD',
      metrics: [
        { label: 'Loss Reduction', value: '54%' },
        { label: 'Events Shielded', value: '298' },
        { label: 'Avg Spike', value: '85 pips' },
      ],
      trades: '1,203',
    },
    {
      symbol: 'US30',
      metrics: [
        { label: 'Loss Reduction', value: '71%' },
        { label: 'Events Shielded', value: '245' },
        { label: 'Avg Spike', value: '450 pts' },
      ],
      trades: '634',
    },
  ],
