...
const data: ProductPageData = {
  ...
  performanceTitle: 'Risk Reduction Data',
  performanceSubtitle: 'Guardian reduces max drawdown by 40-60% on average across tested scenarios.',
  performanceData: [
    {
      symbol: 'XAUUSD',
      metrics: [
        { label: 'DD Reduction', value: '54%' },
        { label: 'Challenges Saved', value: '82%' },
        { label: 'Avg Daily Loss', value: '-2.1%' },
      ],
      trades: '847',
    },
    {
      symbol: 'EURUSD',
      metrics: [
        { label: 'DD Reduction', value: '47%' },
        { label: 'Challenges Saved', value: '78%' },
        { label: 'Avg Daily Loss', value: '-1.4%' },
      ],
      trades: '1,203',
    },
    {
      symbol: 'US30',
      metrics: [
        { label: 'DD Reduction', value: '61%' },
        { label: 'Challenges Saved', value: '85%' },
        { label: 'Avg Daily Loss', value: '-2.8%' },
      ],
      trades: '634',
    },
  ],
