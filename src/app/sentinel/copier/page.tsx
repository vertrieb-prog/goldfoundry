...
const data: ProductPageData = {
  ...
  performanceSubtitle: '99.2% trade copy accuracy with under 2 second average latency.',
  performanceData: [
    {
      symbol: 'XAUUSD',
      metrics: [
        { label: 'Copy Accuracy', value: '99.4%' },
        { label: 'Avg Latency', value: '1.3s' },
        { label: 'Max Slippage', value: '0.8 pts' },
      ],
      trades: '847',
    },
    {
      symbol: 'EURUSD',
      metrics: [
        { label: 'Copy Accuracy', value: '99.6%' },
        { label: 'Avg Latency', value: '1.1s' },
        { label: 'Max Slippage', value: '0.3 pips' },
      ],
      trades: '1,203',
    },
    {
      symbol: 'US30',
      metrics: [
        { label: 'Copy Accuracy', value: '98.9%' },
        { label: 'Avg Latency', value: '1.6s' },
        { label: 'Max Slippage', value: '2.1 pts' },
      ],
      trades: '634',
    },
  ],
