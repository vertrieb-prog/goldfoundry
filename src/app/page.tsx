  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: "var(--gf-obsidian)" }}>
      ...
      {/* ══════════════════════════════════════════
          FOOTER
         ══════════════════════════════════════════ */}
      <footer className="relative z-10 border-t border-white/[0.04] px-6 py-16">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div className="col-span-2 md:col-span-1">
            <div className="text-lg font-bold gf-gold-text mb-2">GOLD FOUNDRY</div>
            <p className="text-xs text-zinc-500 leading-relaxed mb-4">Das All-in-One Trading Terminal für Prop-Firm Trader und Profis.</p>
          ...
          {/* Product */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-4">Produkt</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-4">Ressourcen</h4>
            <div className="flex flex-col gap-2 text-sm text-zinc-500">
              <Link href="/wissen" className="hover:text-[var(--gf-gold)] transition-colors">Wissen</Link>
        ...
        <div className="max-w-6xl mx-auto pt-8 border-t border-white/[0.04]">
          <p className="text-xs text-zinc-600 mb-4 leading-relaxed">
            Risikohinweis: Der Handel mit Finanzinstrumenten ist mit erheblichen Risiken verbunden und kann zum Verlust des eingesetzten Kapitals führen. Vergangene Ergebnisse sind keine Garantie für zukünftige Performance.
          </p>
          <p className="text-xs text-zinc-600 text-center">© 2026 Gold Foundry. Trading birgt Risiken.</p>
        </div>
      </footer>
    </div>
  );
