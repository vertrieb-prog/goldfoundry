// src/app/_subdomain/strategien/page.tsx
...
export default async function StrategienPage() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-8">Strategien &amp; Guides</h1>
      <div className="space-y-4">
        ...
        {(!articles || articles.length === 0) && (
          <p className="text-gray-500">Noch keine Strategien vorhanden.</p>
        )}
      </div>
    </div>
  );
